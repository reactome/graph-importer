...
public class ReactomeBatchImporter {
    ...
    public ReactomeBatchImporter(String host, Integer port, String name, String user, String password, String neo4j, String neo4jVersion) {
        try {
            DATA_DIR = neo4j;
     ...
     * into the GkInstance hierarchy (e.g. hasEvents)
     *
     ...
     * to another GkInstance e.g. values like Strings)
